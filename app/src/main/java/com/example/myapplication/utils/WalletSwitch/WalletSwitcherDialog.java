...
public class WalletSwitcherDialog extends DialogFragment implements WalletSwitcherSwatch.OnWalletSelectedListener {
    ...
    private WalletSwitcherPalette palette;
    private ProgressBar progressBar;
    protected WalletSwitcherSwatch.OnWalletSelectedListener listener;

    public WalletSwitcherDialog(){

    }
    public static WalletSwitcherDialog newInstance(int cols, String[] categories, String selected){
        WalletSwitcherDialog ret = new WalletSwitcherDialog();
        //initialize
        // setArgs
    ...
    public Dialog onCreateDialog(Bundle bundle){
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.wallet_switcher_dialog, null);
        progressBar = (ProgressBar) view.findViewById(R.id.s_wallet_progress_bar);
        palette = (WalletSwitcherPalette) view.findViewById(R.id.s_wallet_picker);
        palette.init(columns, this.listener);
    ...
    public void setOnWalletSelectedListener(WalletSwitcherSwatch.OnWalletSelectedListener _listener){
        listener = _listener;
    }
    @Override
